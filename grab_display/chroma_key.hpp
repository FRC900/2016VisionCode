...
cv::Mat doChromaKey(const cv::gpu::GpuMat &fgImage, const cv::gpu::GpuMat &bgImage, const cv::gpu::GpuMat &mask);
#elif CV_MAJOR_VERSION == 3
cv::Mat doChromaKey(const cv::cuda::GpuMat &fgImage, const cv::cuda::GpuMat &bgImage, const cv::cuda::GpuMat &mask);
#endif
