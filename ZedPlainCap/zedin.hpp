...
class ZedIn
{
   public:
	...
	cv::Mat& getDepth() { return cv_depth; } //various ways to get image data from the camera
	cv::Mat& getFrame() { return cv_frame; }
	cv::Mat& getNormalDepth() { return cv_normalDepth; }
	cv::Mat& getConfidence() { return cv_confidence; }
