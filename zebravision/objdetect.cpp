...
template class ObjDetectNNet<Mat, Classifier<Mat, CaffeClassifierThread<Mat>>>;
template class ObjDetectNNet<GpuMat, Classifier<GpuMat, CaffeClassifierThread<GpuMat>>>;
template class ObjDetectNNet<Mat, Classifier<Mat, GIEClassifierThread<Mat>>>;
template class ObjDetectNNet<GpuMat, Classifier<GpuMat, GIEClassifierThread<GpuMat>>>;
