...
const float dist_to_goal() { return _dist_to_goal; } //floor distance to goal in m
const float angle_to_goal() { return _angle_to_goal; } //angle robot has to turn to face goal in degrees

bool processFrame(Mat &image, Mat &depth); //this updates dist_to_goal and angle_to_goal
